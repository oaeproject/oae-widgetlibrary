...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
     ...
     */
    sakai_global.<%= @file_name %> = function (tuid, showSettings) {
        ...
        var $mainContainer = $("#<%= @file_name %>_main", $rootel);
        var $settingsContainer = $("#<%= @file_name %>_settings", $rootel);
        var $settingsForm = $("#<%= @file_name %>_settings_form", $rootel);
        var $cancelSettings = $("#<%= @file_name %>_cancel_settings", $rootel);
        var $colorPicker = $("#<%= @file_name %>_color", $rootel);
        var $usernameContainer = $("#<%= @file_name %>_username", $rootel);
            ...
            sakai.api.Widgets.saveWidgetData(tuid, {color:selectedColor},
                function (success, data) {
                    if (success) {
                        ...
                        sakai.api.Widgets.Container.informFinish(tuid, "<%= @file_name %>");
                    }
                }
            );
            return false;
    ...
    sakai.api.Widgets.widgetLoader.informOnLoad("<%= @file_name %>");
});